...
1. [First React component JSX and props](01-react-jsx-props.md)
2. [State snapshots forms and immutable updates](02-state-forms.md)
3. [Components JSX and the render cycle](03-components-rendering.md)
...
4. [Composition reusable patterns and styling](04-composition-styling.md)
5. [Effects refs and reusable synchronization](05-effects-custom-hooks.md)
...
6. [Routing nested layouts and URL state](06-routing-url-state.md)
7. [Context reducers and Redux Toolkit](07-context-reducer-redux.md)
8. [Server state caching and Supabase integration](08-query-supabase.md)
9. [TypeScript contracts for React applications](09-typescript-contracts.md)
...
10. [Performance suspense and production quality](10-performance-production.md)
